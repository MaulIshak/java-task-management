...
INSERT INTO users (id, name, email, password_hash) VALUES
                                                       (1, 'Alex Johnson', 'alex@zenith.com', 'secret'),
                                                       (2, 'Sarah Miller', 'sarah@zenith.com', 'secret');
...
INSERT INTO projects (id, organization_id, name, description) VALUES
    (1, 1, 'Phoenix Project', 'A complete overhaul of the main application.');

-- Insert Tasks (ID = 1, 2)
INSERT INTO tasks (id, project_id, assignee_id, title, description, due_date, status) VALUES
                                                                                               (1, 1, 1, 'Implement Login', 'Create login form using JavaFX', '2025-11-30', 'todo'),
                                                                                               (2, 1, 2, 'Fix Database Bug', 'Connection timeout issue', '2025-11-28', 'on progress');